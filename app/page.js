  ...
  return (
    ...
    //**?  why sould ohara start*/
      <div className="container mx-auto mt-14">
        ...
        <div className="flex gap-28 justify-center mt-14">
          <div className="h-64 w-56 rounded-xl shadow-xl my-auto border hover:scale-110 hover:transition-all hover:duration-200">
